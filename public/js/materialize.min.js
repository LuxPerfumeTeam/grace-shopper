...
window.cash = (function() {
  ...
  function v(t, e) {
    ...
    var i = u.test(t)
      ...
      : p.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t)
    return i
  }
  function f(t) {
    if (!i) {
    ...
    removeData: function(s) {
      return this.each(function(t) {
        return (
          ...
          void ((n = M((e = t)))
            ? delete n[i]
            : e.dataset ? delete e.dataset[i] : _(e).removeAttr('data-' + name))
        )
        var e, i, n
      })
    }
    ...
    attr: function(e, i) {
      if (e) {
        if (d(e))
          return void 0 === i
            ? this[0]
              ? this[0].getAttribute ? this[0].getAttribute(e) : this[0][e]
              : void 0
            : this.each(function(t) {
